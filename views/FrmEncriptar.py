...
class Ui_FrmEncriptar(object):
    def setupUi(self, FrmEncriptar):
        ...
        self.lblImagenEncriptada = QtWidgets.QLabel(self.tab_2)
        self.lblImagenEncriptada.setGeometry(QtCore.QRect(10, 250, 471, 171))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lblImagenEncriptada.setFont(font)
        self.lblImagenEncriptada.setText("")
        self.lblImagenEncriptada.setObjectName("lblImagenEncriptada")
        ...
        self.btnCargarImagen.setIcon(icon2)
        ...
        self.lblMensajeImagen = QtWidgets.QLabel(self.tab_2)
        self.lblMensajeImagen.setGeometry(QtCore.QRect(20, 40, 221, 171))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lblMensajeImagen.setFont(font)
        self.lblMensajeImagen.setText("")
        self.lblMensajeImagen.setScaledContents(True)
        self.lblMensajeImagen.setObjectName("lblMensajeImagen")
