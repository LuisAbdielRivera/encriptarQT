...
class Ui_FrmMenu(object):
    def setupUi(self, FrmMenu):
        ...
        self.btnEncriptar.setGeometry(QtCore.QRect(30, 30, 101, 31))
        font = QtGui.QFont()
        ...
        self.btnDesencriptar.setGeometry(QtCore.QRect(140, 30, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
    ...
    def retranslateUi(self, FrmMenu):
        ...
        self.btnEncriptar.setText(_translate("FrmMenu", "Encriptar"))
        self.btnDesencriptar.setText(_translate("FrmMenu", "Desencriptar"))
